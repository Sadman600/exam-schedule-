...
const EditExamSchedule = () => {
    ...
    const exam1 = [
        { label: 'SSC Model Test-1', value: 'GST Model Test-1' },
        { label: 'SSC Model Test-2', value: 'SSC Model Test-2' },
        { label: 'SSC Model Test-3', value: 'SSC Model Test-3' },
        { label: 'SSC Model Test-4', value: 'SSC Model Test-4' },
    ];
    const exam2 = [
        { label: 'Unit-A Science', value: 'Unit-A Science' },
        { label: 'Unit-B Science', value: 'Unit-B Science' },
        { label: 'Unit-C Science', value: 'Unit-C Science' },
    ];
    ...
    return (
        <div className='w-auto px-5'>
            <Fieldset legend="Edit Exam Schedule">
                <Toast ref={toastRef} />
                <form onSubmit={handleUpdateExam}>
                    ...
                    <div className='w-25 mx-auto'>
                        <Button type="submit" label="Update" className="mt-2" icon="pi pi-check" iconPos="left" />
                        <span className='mx-2'><Button onClick={() => navigate('/')} label="Cancel" icon="pi pi-times" iconPos="left" className="p-button-warning" /></span>
                    </div>
                </ form>
            </Fieldset>
        </div>
